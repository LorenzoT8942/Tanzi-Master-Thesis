...
def generate_robust_skin_mesh(filepath):
    ...
    # Prendi il Principled BSDF
    principled = nodes.get("Principled BSDF")

    # Impostazioni materiale metallico
    principled.inputs["Metallic"].default_value = 1.0      # 100% metallo
    principled.inputs["Roughness"].default_value = 0.02    # molto riflettente
    principled.inputs["Base Color"].default_value = (0.8, 0.8, 0.8, 1)  # grigio metallo
